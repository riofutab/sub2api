...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageDashboardStatsCache := repository.NewUsageDashboardStatsCache(redisClient)
	usageService := service.NewUsageService(usageLogRepository, userRepository, client, apiKeyAuthCacheInvalidator, usageDashboardStatsCache)
