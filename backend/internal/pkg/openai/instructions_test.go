...
func TestCodexBaseInstructionsForModel(t *testing.T) {
	cases := []struct {
		...
		{"OPENAI/GPT-6_LUNA", "You are Codex, an agent based on GPT-6"},
		{"openai/gpt-6-sol-2026-09-23", "You are Codex, an agent based on GPT-6"},
		{"gpt-6-luna-2026-09-23", "You are Codex, an agent based on GPT-6"},
		{"gpt-6-solar", "You are Codex, a coding agent based on GPT-5"},
		{"gpt-6-lunatic", "You are Codex, a coding agent based on GPT-5"},
